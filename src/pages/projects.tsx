  ...
  return (
    <>
      ...
      <main>
        ...
        <div className="flex items-center">
          ...
          <div>
            <button
              ...
              className="btn btn-secondary text-gray-200 font-medium"
              type="button"
            >
              <svg
              ...
              {data.map(({ _id, name, type, visibility, files_id }, key) => (
                <tr className="hover:bg-gray-800">
                  ...
                  <th>
                    <button
                      onClick={() => {
                        setEditModalValues({ _id, name, type, visibility });
        ...
        />
        <EditProjectModal
          id={editModalValues._id}
          name={editModalValues.name}
          type={editModalValues.type}
          visibility={editModalValues.visibility}
